  ...
  return (
    <main className="min-h-screen bg-surface-alt">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <Link href="/" className="text-sm text-primary-600 hover:underline mb-6 inline-block">
          ← Back to search
        </Link>
        ...
        <div className="relative aspect-[16/7] bg-surface-alt rounded-lg overflow-hidden mb-8">
          ...
          {property.image_count > 0 && (
            <span className="absolute bottom-4 right-4 bg-black/60 text-white text-sm px-3 py-1.5 rounded">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-8">
          ...
          <div className="text-right">
            ...
            <div className="text-sm text-muted mt-1">
              {property.currencyCode} · {property.eurPrice.toLocaleString()} EUR
            </div>
          </div>
        </div>
